...
public class AlphaBeta extends MoveAlgo {
	...
	public void minimax(int player, int depth){
		...
		if(this.white)
			val = Max(depth,Integer.MIN_VALUE,Integer.MAX_VALUE); // white moves first
		else
			val = Min(depth,Integer.MIN_VALUE,Integer.MAX_VALUE); // black moves first
	}
